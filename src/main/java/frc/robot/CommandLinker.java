...
public class CommandLinker 
{
  ...
  public void configureCommands()
  {
    ...
    Button FALCON_BUTTON = new JoystickButton(this.DRIVE_JOYSTICK, 7);
    Button FALCON_REVERSE_BUTTON = new JoystickButton(this.DRIVE_JOYSTICK, 8);

    Button FALCON_TWO_BUTTON = new JoystickButton(this.DRIVE_JOYSTICK, 11);
    Button FALCON_TWO_REVERSE_BUTTON = new JoystickButton(this.DRIVE_JOYSTICK, 12);
    ...
    FALCON_BUTTON.whileHeld(new Falcon());
    FALCON_REVERSE_BUTTON.whileHeld(new FalconReverse());

    FALCON_TWO_BUTTON.whileHeld(new FalconSetTwo());
    FALCON_TWO_REVERSE_BUTTON.whileHeld(new FalconSetTwoReverse());
